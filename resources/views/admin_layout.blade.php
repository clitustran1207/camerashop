...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" href="admin/h_panel/assets/images/favicon.png" type="image/x-icon">
    <link rel="icon" href="admin/h_panel/assets/images/favicon.ico" type="image/x-icon">
    ...
    <!-- iconfont -->
    <link rel="stylesheet" type="text/css" href="admin/h_panel/assets/icon/icofont/css/icofont.css">

    <!-- simple line icon -->
    <link rel="stylesheet" type="text/css" href="admin/h_panel/assets/icon/simple-line-icons/css/simple-line-icons.css">

    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="admin/bower_components/bootstrap/css/bootstrap.min.css">

    <!-- weather css -->
    <link rel="stylesheet" type="text/css" href="admin/h_panel/assets/icon/weather-icons/css/weather-icons.min.css">
    <link rel="stylesheet" type="text/css" href="admin/h_panel/assets/icon/weather-icons/css/weather-icons-wind.min.css">

    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="admin/h_panel/assets/scss/main.css">

    <!-- Responsive.css-->
    <link rel="stylesheet" type="text/css" href="admin/h_panel/assets/css/responsive.css">    

    <!--color css-->
    <link rel="stylesheet" type="text/css" href="admin/h_panel/assets/css/color/color-1.min.css" id="color"/>
    @yield('css')
</head>
<body class="horizontal-fixed fixed">
  <div class="wrapper">
    ...
    <header class="main-header-top hidden-print">
      <a href="index.html" class="logo"><img class="img-fluid able-logo" src="admin/h_panel/assets/images/logo.png" alt="Theme-logo"></a>
        ...
        <div class="navbar-custom-menu">
              ...
              <li class="dropdown notification-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="bell-notification">
                    <a href="javascript:;" class="media">
                      <span class="mr-3 media-icon">
                        <img class="rounded-circle" src="admin/h_panel/assets/images/avatar-1.png" alt="User Image">
                      </span>
                  ...
                  <li class="bell-notification">
                    <a href="javascript:;" class="media">
                      <span class="mr-3 media-icon">
                        <img class="rounded-circle" src="admin/h_panel/assets/images/avatar-2.png" alt="User Image">
                      </span>
                  ...
                  <li class="bell-notification">
                    <a href="javascript:;" class="media">
                      <span class="mr-3 media-icon">
                        <img class="rounded-circle" src="admin/h_panel/assets/images/avatar-3.png" alt="User Image">
                      </span>
            ...
            <!-- User Menu-->
              <li class="dropdown">
                <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                  <span><img class="rounded-circle " src="admin/h_panel/assets/images/avatar-1.png" style="width:40px;" alt="User Image"></span>
          ...
          <!-- search start-->
            <div id="morphsearch" class="morphsearch">
              ...
              <input class="morphsearch-input" type="search" placeholder="Search admin."/>
              ...
              <div class="morphsearch-content">
                ...
                <h2>Popular</h2>
                <a class="dummy-media-object" href="#!">
                <img src="admin/h_panel/assets/images/avatar-1.png" alt="PagePreloadingEffect"/>
                <h3>Page Preloading Effect</h3>
                </a>

                <a class="dummy-media-object" href="#!">
                <img src="admin/h_panel/assets/images/avatar-1.png" alt="DraggableDualViewSlideshow"/>
                ...
                <div class="dummy-column">
                  <h2>Recent</h2>
                  <a class="dummy-media-object" href="#!">
                    <img src="admin/h_panel/assets/images/avatar-1.png" alt="TooltipStylesInspiration"/>
                    <h3>Tooltip Styles Inspiration</h3>
                  </a>
                  <a class="dummy-media-object" href="#!">
                    <img src="admin/h_panel/assets/images/avatar-1.png" alt="NotificationStyles"/>
      ...
      <aside class="main-sidebar hidden-print ">
        <section class="sidebar" id="sidebar-scroll">
          <div class="user-panel">
            <div class="f-left image"><img src="admin/h_panel/assets/images/avatar-1.png" alt="User Image" class="rounded-circle"></div>
          ...
          <!--horizontal Menu Starts-->
            <ul class="sidebar-menu">
              ...
              <li><a href="widget.html"><i class="icon-grid"></i><span>  Widget </span></a></li>
                  ...
                  <li class="col-md-3">
                    <div class="card-block mega-card">
                      ...
                      <ul class="mega-list row">
                        <li class="col-xs-12 col-md-6">
                          <ul>
                            <li><a class="waves-effect waves-dark" href="admin/ltr-vertical/menu-static.html" target="_blank"><i class="icon-arrow-right"></i> Static Layout</a></li>
                            <li><a class="waves-effect waves-dark" href="admin/ltr-vertical/menu-fixed.html" target="_blank"><i class="icon-arrow-right"></i> Header and Sidebar Fixed</a></li>
                            <li><a class="waves-effect waves-dark" href="admin/ltr-vertical/menu-sidebar-sticky.html" target="_blank"><i class="icon-arrow-right"></i> Sidebar Sticky</a></li>
                            <li><a class="waves-effect waves-dark" href="admin/ltr-vertical/menu-header-fixed.html" target="_blank"><i class="icon-arrow-right"></i> Header Fixed</a></li>
                        ...
                        <li class="col-xs-12 col-md-6">
                          <ul>
                            ...
                            <li><a class="waves-effect waves-dark" href="admin/ltr-vertical/menu-footer-fixed.html" target="_blank"><i class="icon-arrow-right"></i> Footer Fixed</a></li>
              ...
              <li class="active treeview"><a href="#"><i class="icon-user-follow"></i><span>  Pages  </span><i class="icon-arrow-down"></i></a>
                <ul class="mega-menu treeview-menu">
                  <li class="col-md-3">
                    <div class="card-block mega-card">
                      ...
                      <ul class="mega-list row">
                        ...
                        <li class="col-xs-12 col-md-6">
                          <ul>
                            ...
                            <li class="h-active"><a class="waves-effect waves-dark" href="sample-page.html"><i class="icon-arrow-right"></i> Sample Page</a></li>
            ...
            <div class="card-content user-box">
              ...
              <div class="main-friend-list">
                <div class="media friendlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                  ...
                  <a class="mr-3" href="#!">
                    <img class="media-object rounded-circle" src="admin/h_panel/assets/images/avatar-1.png" alt="Generic placeholder image">
      ...
      <div class="showChat_inner">
        ...
        <div class="media chat-messages">
          <a class="mr-3 photo-table" href="#!">
            <img class="media-object rounded-circle m-t-5" src="admin/h_panel/assets/images/avatar-1.png" alt="Generic placeholder image">
            <div class="live-status bg-success"></div>
          </a>
        ...
        <div class="media chat-messages">
          ...
          <div class="media-right photo-table">
            <a href="#!">
              <img class="media-object rounded-circle m-t-5" src="admin/h_panel/assets/images/avatar-2.png" alt="Generic placeholder image">
              <div class="live-status bg-success"></div>
            </a>
          </div>
        </div>
            ...
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="sample-page.html">Sample page</a></li>
                    </ol>
                </div>
            </div>
        </div>
  ...
  <!-- waves effects.js -->
  <script src="admin/h_panel/assets/plugins/waves/js/waves.min.js"></script>

  <!-- Scrollbar JS-->
  <script type="text/javascript" src="admin/bower_components/jquery-slimscroll/js/jquery.slimscroll.js"></script>
  <script type="text/javascript" src="admin/h_panel/assets/plugins/jquery.nicescroll/js/jquery.nicescroll.min.js"></script>

  <!--classic JS-->
  <script type="text/javascript" src="admin/bower_components/classie/js/classie.js"></script>

  <!-- notification -->
  <script type="text/javascript" src="admin/h_panel/assets/plugins/notification/js/bootstrap-growl.min.js"></script>

  <!-- custom js -->
  <script type="text/javascript" src="admin/h_panel/assets/js/main.min.js"></script>
  <script type="text/javascript" src="admin/h_panel/assets/pages/elements.js"></script>
  <script src="admin/h_panel/assets/js/menu-horizontal.min.js"></script>
  @yield('js')
</body>
</html>
