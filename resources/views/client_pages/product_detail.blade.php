			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="client/images/si.jpg">
								<div class="thumb-image">
									<img src="client/images/si.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="client/images/si2.jpg">
								<div class="thumb-image">
									<img src="client/images/si2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="client/images/si3.jpg">
								<div class="thumb-image">
									<img src="client/images/si3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						</ul>
