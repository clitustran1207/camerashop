...
<link rel="stylesheet" type="text/css" href="admin/h_panel/assets/plugins/data-table/css/buttons.dataTables.min.css">
...
@section('js')
	...
	<script src="admin/h_panel/assets/plugins/data-table/js/jszip.min.js"></script>
	<script src="admin/h_panel/assets/plugins/data-table/js/pdfmake.min.js"></script>
	<script src="admin/h_panel/assets/plugins/data-table/js/vfs_fonts.js"></script>
	...
	<!-- custom js -->
	<script src="admin/h_panel/assets/pages/data-table.js"></script>
@endsection