...
<head>
	...
	<meta name="keywords" content="Grocery Shoppy Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	<!-- <script>
	...
	<!--//pop-up-box-->
	<!-- price range -->
	<link rel="stylesheet" type="text/css" href="client/css/jquery-ui1.css">
	<!-- fonts -->
...
<body>
			...
			<div class="col-md-4 logo_agile">
				<h1>
					<a href="index.html">
						<span>G</span>rocery
						<span>S</span>hoppy
						<img src="client/images/logo2.png" alt=" ">
					</a>
				</h1>
			</div>
			<!-- header-bot -->
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											...
											<div class="col-sm-4 multi-gd-img">
												<img src="client/images/nav.png" alt="">
											</div>
											<div class="clearfix"></div>
										</div>
									</ul>
	...
	<div class="footer-top">
		<div class="container-fluid">
			...
			<div class="col-xs-4 w3l-rightmk">
				<img src="client/images/tab3.png" alt=" ">
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="client/images/pay2.png" alt="">
						</li>
						<li>
							<img src="client/images/pay5.png" alt="">
						</li>
						<li>
							<img src="client/images/pay1.png" alt="">
						</li>
						<li>
							<img src="client/images/pay4.png" alt="">
						</li>
						<li>
							<img src="client/images/pay6.png" alt="">
						</li>
						<li>
							<img src="client/images/pay3.png" alt="">
						</li>
						<li>
							<img src="client/images/pay7.png" alt="">
						</li>
						<li>
							<img src="client/images/pay8.png" alt="">
						</li>
						<li>
							<img src="client/images/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<!-- jquery -->
	<script src="client/js/jquery-2.1.4.min.js"></script>
	<!-- //jquery -->
	...
	<script src="client/js/jquery.flexisel.js"></script>
	<script>
		$(window).load(function () {
